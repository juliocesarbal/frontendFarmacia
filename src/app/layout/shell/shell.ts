...
export class ShellComponent {
  private readonly items: MenuItem[] = [
    ...
    { ruta: '/productos', texto: 'Productos', icono: 'bi-capsule', grupo: 'Catalogo' },
    { ruta: '/catalogos', texto: 'Categorias y unidades', icono: 'bi-tags', permiso: 'catalogos.gestionar', grupo: 'Catalogo' },
    { ruta: '/proveedores', texto: 'Proveedores', icono: 'bi-truck', grupo: 'Catalogo' },
    { ruta: '/compras', texto: 'Compras', icono: 'bi-cart-plus', grupo: 'Operaciones' },
    { ruta: '/ventas', texto: 'Ventas', icono: 'bi-cash-coin', grupo: 'Operaciones' },
    { ruta: '/bajas', texto: 'Bajas', icono: 'bi-trash3', grupo: 'Operaciones' },
    { ruta: '/ajustes', texto: 'Ajustes', icono: 'bi-sliders', grupo: 'Operaciones' },
    { ruta: '/inventario', texto: 'Inventario', icono: 'bi-box-seam', grupo: 'Inventario' },
    ...
    { ruta: '/importaciones', texto: 'Importar Excel', icono: 'bi-file-earmark-arrow-up', permiso: 'importaciones.gestionar', grupo: 'Analisis' },
